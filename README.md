...
This back-end project is designed to seamlessly integrate with its counterpart *front-end project* 👉🏽[handyhomehub_frontend](https://github.com/jicamargo/handyhomehub_frontend). The front-end, built with React.js and Redux, consumes the API provided by this back-end to provide a user-friendly interface for booking appointments.
...
```
  git clone https://github.com/jicamargo/handyhomehub_backend.git
```
...
1. **Front End**: To install the front-end of this project, please visit the [handyhomehub_frontend](https://github.com/jicamargo/handyhomehub_frontend) repository and follow the instructions in the README.md file.
...
Feel free to check the [issues page](https://github.com/jicamargo/handyhomehub_backend/issues).
